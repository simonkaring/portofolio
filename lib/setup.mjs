...
export const about = () => {
  return (
    <>
      Hey, I'm a developer with a passion for web design looking for a job as a Software Engineer.
    </>
  );
};
export const bio = () => {
  return (
    <>
      When I'm not coding, I'm probably playing video games or watching movies. I also love to drink coffee, hangout with friends and travel.
    </>
  );
};
`;
